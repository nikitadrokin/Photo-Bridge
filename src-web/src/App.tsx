...
const features = [
  {
    title: 'Photos',
    description: 'Converts HEIC to JPG while preserving all EXIF metadata — location, timestamps, camera info.',
  },
  {
    title: 'Videos',
    description: 'Remuxes MOV/HEVC to MP4 without re-encoding. No quality loss, HDR preserved, audio converted to AAC.',
  },
  {
    title: 'Metadata',
    description: 'Fixes file creation dates to match the original capture time so your library stays in order.',
  },
  {
    title: 'Batch',
    description: 'Process entire folders at once. Converted files land in a _Remuxed subdirectory, originals untouched.',
  },
];
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white selection:bg-white/20">
      ...
      <header className="mx-auto flex max-w-5xl items-center justify-between px-6 py-6">
        <span className="text-sm font-semibold tracking-tight text-white/90">PhotoBridge</span>
        <a
      ...
      <main className="mx-auto max-w-5xl px-6 pb-32 pt-20 text-center">
        ...
        <p className="mx-auto mb-12 max-w-xl text-lg text-white/50">
          PhotoBridge converts HEIC photos and MOV videos into formats your Pixel can handle —
          without re-encoding, without losing metadata, without the headache.
        </p>

        <div className="mx-auto mb-4 max-w-md">
          <CopyButton text={BREW_COMMAND} />
        </div>
        <p className="text-xs text-white/30">Requires Homebrew · macOS only</p>
      </main>
